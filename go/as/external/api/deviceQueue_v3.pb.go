...
func (*DeviceQueueItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_3102f065ea22c261, []int{0}
}
...
func (*EnqueueDeviceQueueItemRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3102f065ea22c261, []int{1}
}
...
func (*EnqueueDeviceQueueItemResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3102f065ea22c261, []int{2}
}
...
func (*FlushDeviceQueueRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3102f065ea22c261, []int{3}
}
...
func (*ListDeviceQueueItemsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3102f065ea22c261, []int{4}
}
...
func (*ListDeviceQueueItemsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3102f065ea22c261, []int{5}
}
...
func init() {
	proto.RegisterType((*DeviceQueueItem)(nil), "api_v3.DeviceQueueItem")
	proto.RegisterType((*EnqueueDeviceQueueItemRequest)(nil), "api_v3.EnqueueDeviceQueueItemRequest")
	proto.RegisterType((*EnqueueDeviceQueueItemResponse)(nil), "api_v3.EnqueueDeviceQueueItemResponse")
	proto.RegisterType((*FlushDeviceQueueRequest)(nil), "api_v3.FlushDeviceQueueRequest")
	proto.RegisterType((*ListDeviceQueueItemsRequest)(nil), "api_v3.ListDeviceQueueItemsRequest")
	proto.RegisterType((*ListDeviceQueueItemsResponse)(nil), "api_v3.ListDeviceQueueItemsResponse")
}

func init() {
	proto.RegisterFile("as/external/api/deviceQueue_v3.proto", fileDescriptor_3102f065ea22c261)
}

var fileDescriptor_3102f065ea22c261 = []byte{
	// 578 bytes of a gzipped FileDescriptorProto
	,
}
