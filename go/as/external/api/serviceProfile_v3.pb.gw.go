...
func local_request_ServiceProfileService_Create_0(ctx context.Context, marshaler runtime.Marshaler, server ServiceProfileServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateServiceProfileRequest
	var metadata runtime.ServerMetadata
...
func local_request_ServiceProfileService_Get_0(ctx context.Context, marshaler runtime.Marshaler, server ServiceProfileServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetServiceProfileRequest
	var metadata runtime.ServerMetadata
...
func local_request_ServiceProfileService_Update_0(ctx context.Context, marshaler runtime.Marshaler, server ServiceProfileServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateServiceProfileRequest
	var metadata runtime.ServerMetadata
...
func local_request_ServiceProfileService_Delete_0(ctx context.Context, marshaler runtime.Marshaler, server ServiceProfileServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteServiceProfileRequest
	var metadata runtime.ServerMetadata
...
func local_request_ServiceProfileService_List_0(ctx context.Context, marshaler runtime.Marshaler, server ServiceProfileServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListServiceProfileRequest
	var metadata runtime.ServerMetadata
...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterServiceProfileServiceHandlerFromEndpoint instead.
func RegisterServiceProfileServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ServiceProfileServiceServer) error {
	...
	mux.Handle("POST", pattern_ServiceProfileService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ServiceProfileService_Create_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_ServiceProfileService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ServiceProfileService_Get_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("PUT", pattern_ServiceProfileService_Update_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ServiceProfileService_Update_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("DELETE", pattern_ServiceProfileService_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ServiceProfileService_Delete_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_ServiceProfileService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ServiceProfileService_List_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
...
// RegisterServiceProfileServiceHandlerClient registers the http handlers for service ServiceProfileService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ServiceProfileServiceClient".
...
var (
	pattern_ServiceProfileService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "service-profiles"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ServiceProfileService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "service-profiles", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ServiceProfileService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "service-profiles", "service_profile.id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ServiceProfileService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "service-profiles", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ServiceProfileService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "service-profiles"}, "", runtime.AssumeColonVerbOpt(true)))
)
