...
func (RatePolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_as_external_api_profiles_v3_proto_enumTypes[0].Descriptor()
}

func (RatePolicy) Type() protoreflect.EnumType {
	return &file_as_external_api_profiles_v3_proto_enumTypes[0]
}
...
func (RatePolicy) EnumDescriptor() ([]byte, []int) {
	return file_as_external_api_profiles_v3_proto_rawDescGZIP(), []int{0}
}
...
func (x *ServiceProfile) Reset() {
	*x = ServiceProfile{}
	mi := &file_as_external_api_profiles_v3_proto_msgTypes[0]
...
func (x *DeviceProfile) Reset() {
	*x = DeviceProfile{}
	mi := &file_as_external_api_profiles_v3_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeviceProfile) Descriptor() ([]byte, []int) {
	return file_as_external_api_profiles_v3_proto_rawDescGZIP(), []int{1}
}
...
var File_as_external_api_profiles_v3_proto protoreflect.FileDescriptor

const file_as_external_api_profiles_v3_proto_rawDesc = "" +
	"\n" +
	"!as/external/api/profiles_v3.proto\x12\x06api_v3\x1a\x1egoogle/protobuf/duration.proto\"\xfe\x06\n" +
	...
	"\x0eul_bucket_size\x18\x03 \x01(\rR\fulBucketSize\x128\n" +
	"\x0eul_rate_policy\x18\x04 \x01(\x0e2\x12.api_v3.RatePolicyR\fulRatePolicy\x12\x17\n" +
	"\adl_rate\x18\x05 \x01(\rR\x06dlRate\x12$\n" +
	"\x0edl_bucket_size\x18\x06 \x01(\rR\fdlBucketSize\x128\n" +
	"\x0edl_rate_policy\x18\a \x01(\x0e2\x12.api_v3.RatePolicyR\fdlRatePolicy\x12&\n" +
	...
	"\rpayload_codec\x18\x18 \x01(\tR\fpayloadCodec\x124\n" +
	"\x16payload_encoder_script\x18\x19 \x01(\tR\x14payloadEncoderScript\x124\n" +
	"\x16payload_decoder_script\x18\x1a \x01(\tR\x14payloadDecoderScript\x12*\n" +
	"\x11geoloc_buffer_ttl\x18\x1b \x01(\rR\x0fgeolocBufferTTL\x123\n" +
	"\x16geoloc_min_buffer_size\x18\x1c \x01(\rR\x13geolocMinBufferSize\x123\n" +
	"\x04tags\x18\x1d \x03(\v2\x1f.api_v3.DeviceProfile.TagsEntryR\x04tags\x12B\n" +
	"\x0fuplink_interval\x18\x1e \x01(\v2\x19.google.protobuf.DurationR\x0euplinkInterval\x12(\n" +
	"\x10adr_algorithm_id\x18\x1f \x01(\tR\x0eadrAlgorithmID\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
...
var (
	...
	file_as_external_api_profiles_v3_proto_rawDescData []byte
)

func file_as_external_api_profiles_v3_proto_rawDescGZIP() []byte {
	file_as_external_api_profiles_v3_proto_rawDescOnce.Do(func() {
		file_as_external_api_profiles_v3_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_as_external_api_profiles_v3_proto_rawDesc), len(file_as_external_api_profiles_v3_proto_rawDesc)))
	})
	return file_as_external_api_profiles_v3_proto_rawDescData
}

var file_as_external_api_profiles_v3_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_as_external_api_profiles_v3_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_as_external_api_profiles_v3_proto_goTypes = []any{
	(RatePolicy)(0),           // 0: api_v3.RatePolicy
	(*ServiceProfile)(nil),    // 1: api_v3.ServiceProfile
	(*DeviceProfile)(nil),     // 2: api_v3.DeviceProfile
	nil,                       // 3: api_v3.DeviceProfile.TagsEntry
	(*duration.Duration)(nil), // 4: google.protobuf.Duration
}
var file_as_external_api_profiles_v3_proto_depIdxs = []int32{
	0, // 0: api_v3.ServiceProfile.ul_rate_policy:type_name -> api_v3.RatePolicy
	0, // 1: api_v3.ServiceProfile.dl_rate_policy:type_name -> api_v3.RatePolicy
	3, // 2: api_v3.DeviceProfile.tags:type_name -> api_v3.DeviceProfile.TagsEntry
	4, // 3: api_v3.DeviceProfile.uplink_interval:type_name -> google.protobuf.Duration
...
func init() { file_as_external_api_profiles_v3_proto_init() }
func file_as_external_api_profiles_v3_proto_init() {
	if File_as_external_api_profiles_v3_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_as_external_api_profiles_v3_proto_rawDesc), len(file_as_external_api_profiles_v3_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_as_external_api_profiles_v3_proto_goTypes,
		DependencyIndexes: file_as_external_api_profiles_v3_proto_depIdxs,
		EnumInfos:         file_as_external_api_profiles_v3_proto_enumTypes,
		MessageInfos:      file_as_external_api_profiles_v3_proto_msgTypes,
	}.Build()
	File_as_external_api_profiles_v3_proto = out.File
	file_as_external_api_profiles_v3_proto_goTypes = nil
	file_as_external_api_profiles_v3_proto_depIdxs = nil
}
