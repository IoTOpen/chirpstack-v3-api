...
// source: as/external/api/profiles_v3.proto
...
func (RatePolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_649ca832270711ed, []int{0}
}
...
type ServiceProfile struct {
	...
	UlRatePolicy RatePolicy `protobuf:"varint,4,opt,name=ul_rate_policy,json=ulRatePolicy,proto3,enum=api_v3.RatePolicy" json:"ul_rate_policy,omitempty"`
	// Token bucket filling rate, including ACKs (packet/h).
	...
	DlRatePolicy RatePolicy `protobuf:"varint,7,opt,name=dl_rate_policy,json=dlRatePolicy,proto3,enum=api_v3.RatePolicy" json:"dl_rate_policy,omitempty"`
...
func (*DeviceProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_649ca832270711ed, []int{1}
}
...
func init() {
	proto.RegisterEnum("api_v3.RatePolicy", RatePolicy_name, RatePolicy_value)
	proto.RegisterType((*ServiceProfile)(nil), "api_v3.ServiceProfile")
	proto.RegisterType((*DeviceProfile)(nil), "api_v3.DeviceProfile")
	proto.RegisterMapType((map[string]string)(nil), "api_v3.DeviceProfile.TagsEntry")
}

func init() {
	proto.RegisterFile("as/external/api/profiles_v3.proto", fileDescriptor_649ca832270711ed)
}

var fileDescriptor_649ca832270711ed = []byte{
	// 1263 bytes of a gzipped FileDescriptorProto
	,
}
