...
func local_request_NetworkServerService_Create_0(ctx context.Context, marshaler runtime.Marshaler, server NetworkServerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateNetworkServerRequest
	var metadata runtime.ServerMetadata
...
func local_request_NetworkServerService_Get_0(ctx context.Context, marshaler runtime.Marshaler, server NetworkServerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetNetworkServerRequest
	var metadata runtime.ServerMetadata
...
func local_request_NetworkServerService_Update_0(ctx context.Context, marshaler runtime.Marshaler, server NetworkServerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateNetworkServerRequest
	var metadata runtime.ServerMetadata
...
func local_request_NetworkServerService_Delete_0(ctx context.Context, marshaler runtime.Marshaler, server NetworkServerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteNetworkServerRequest
	var metadata runtime.ServerMetadata
...
func local_request_NetworkServerService_List_0(ctx context.Context, marshaler runtime.Marshaler, server NetworkServerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListNetworkServerRequest
	var metadata runtime.ServerMetadata
...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterNetworkServerServiceHandlerFromEndpoint instead.
func RegisterNetworkServerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NetworkServerServiceServer) error {
	...
	mux.Handle("POST", pattern_NetworkServerService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_NetworkServerService_Create_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_NetworkServerService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_NetworkServerService_Get_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("PUT", pattern_NetworkServerService_Update_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_NetworkServerService_Update_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("DELETE", pattern_NetworkServerService_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_NetworkServerService_Delete_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_NetworkServerService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_NetworkServerService_List_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
...
var (
	pattern_NetworkServerService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "network-servers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_NetworkServerService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "network-servers", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_NetworkServerService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "network-servers", "network_server.id"}, "", runtime.AssumeColonVerbOpt(true)))
